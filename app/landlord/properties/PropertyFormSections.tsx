...
export function ShortTermSection({ formData, handleInputChange }: PropertyFormSectionsProps) {
  return (
    <div>
      <h2 className="text-xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200">🌙 Short-Term / Overnight Stays</h2>
      <div className="space-y-6">
        {/* Radio toggle */}
        <div>
          <p className="text-sm font-medium text-gray-700 mb-3">Do you offer short-term / overnight bookings?</p>
          <div className="flex gap-4">
            <label className="flex items-center gap-2 cursor-pointer p-4 border rounded-lg flex-1 hover:bg-gray-50 transition-colors">
              <input
                type="radio"
                name="shortTermAvailable"
                value="true"
                checked={formData.shortTermAvailable === true}
                onChange={() =>
                  handleInputChange({ target: { name: 'shortTermAvailable', value: 'true', type: 'radio' } } as any)
                }
                className="w-4 h-4 text-emerald-600"
              />
              <div>
                <span className="text-sm font-medium text-gray-900">Yes, offer short stays</span>
                <p className="text-xs text-gray-500">Tenants can book by the night</p>
              </div>
            </label>
            <label className="flex items-center gap-2 cursor-pointer p-4 border rounded-lg flex-1 hover:bg-gray-50 transition-colors">
              <input
                ...
                name="shortTermAvailable"
                value="false"
                checked={formData.shortTermAvailable === false}
                onChange={() =>
                  handleInputChange({ target: { name: 'shortTermAvailable', value: 'false', type: 'radio' } } as any)
                }
                className="w-4 h-4 text-emerald-600"
              />
              <div>
                <span className="text-sm font-medium text-gray-900">No, long-term only</span>
                <p className="text-xs text-gray-500">Monthly rentals only</p>
              </div>
            </label>
          </div>
        </div>

        {formData.shortTermAvailable && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <input
                type="number"
                name="shortTermPricePerNight"
                value={formData.shortTermPricePerNight}
                onChange={handleInputChange}
                placeholder="e.g., 50"
                min="1"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
            ...
            <div>
              ...
              <input
                type="number"
                name="shortTermMinNights"
                value={formData.shortTermMinNights}
                onChange={handleInputChange}
                placeholder="1"
                min="1"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Maximum Nights (optional)</label>
              <input
                type="number"
                name="shortTermMaxNights"
                value={formData.shortTermMaxNights}
                onChange={handleInputChange}
                placeholder="e.g., 30"
                min="1"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"

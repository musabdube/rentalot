...
import { ArrowLeft, Save, Send, X, Image as ImageIcon, PenLine } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-2"><PenLine className="w-7 h-7 text-emerald-600" />Edit Blog Post</h1>
